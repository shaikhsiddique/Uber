...
function ConfirmRide({setConfirmRidePanel,setVehicleFound}) {
  return (
    <div className="w-screen px-3 ">
      ...
      <h3 className="text-2xl gap-2 font-semibold mb-3 text-black ">Confirm your ride</h3>
     ...
     <button onClick={()=>{setConfirmRidePanel(false);setVehicleFound(true)}} className="w-full bg-green-600 text-white font-semibold p-2  rounded-lg ">
        Confrim
      </button>
     </div>
      </div>
